...
WebUI.takeScreenshot('screenshots/open_browser.png')

// Navigate to URL and login
WebUI.navigateToUrl('https://threads0.myshopify.com/password')
WebUI.click(findTestObject('Object Repository/Thread_Webshop/Shopping Cart/Order Summary/Page_Threads/div_Enter using password'))
WebUI.setEncryptedText(findTestObject('Object Repository/Thread_Webshop/Shopping Cart/Order Summary/Page_Threads/input_Enter store using password_password'), 'gnzTAVlujIw+lTr0To6+Cg==')
WebUI.click(findTestObject('Object Repository/Thread_Webshop/Shopping Cart/Order Summary/Page_Threads/button_Enter'))
...
WebUI.setText(findTestObject('Object Repository/Thread_Webshop/Shopping Cart/Order Summary/Page_Checkout - Threads/input_Address_address1'), 'jfjbsbs')
WebUI.takeScreenshot('screenshots/enter_address.png')
WebUI.setText(findTestObject('Object Repository/Thread_Webshop/Shopping Cart/Order Summary/Page_Checkout - Threads/input_Apartment, suite, etc. (optional)_address2'), 'segeg')
WebUI.takeScreenshot('screenshots/enter_apartment.png')
WebUI.setText(findTestObject('Object Repository/Thread_Webshop/Shopping Cart/Order Summary/Page_Checkout - Threads/input_City_city'), 'efe')
...
WebUI.setText(findTestObject('Object Repository/Thread_Webshop/Shopping Cart/Order Summary/Page_Checkout - Threads/input_Card number_number'), '2222 1111 3333 4444')
WebUI.takeScreenshot('screenshots/enter_card_number.png')
WebUI.setText(findTestObject('Object Repository/Thread_Webshop/Shopping Cart/Order Summary/Page_Checkout - Threads/input_Expiration date (MM  YY)_expiry'), '12 / 26')
WebUI.takeScreenshot('screenshots/enter_expiry.png')
WebUI.setText(findTestObject('Object Repository/Thread_Webshop/Shopping Cart/Order Summary/Page_Checkout - Threads/input_Security code_verification_value'), '567')
